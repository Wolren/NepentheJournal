...
object FuzzSeed {
    ...
    private val tagPool = listOf(
        ...
        "low_dose", "high_dose", "evening", "morning", "outdoors",
        "indoor", "alone", "with_friends", "with_partner", "music",
    ...
    fun generate(repo: JournalRepository) {
        ...
        if (substances.size < 2) {
            println("FuzzSeed: need at least 2 substances, have ${substances.size}. Skipping.")
            return
        }
